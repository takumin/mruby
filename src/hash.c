 ...
 * it twice. So a walk that found nothing looks once more by identity, which
 * sends nothing and so leaves nothing behind it to miss.
 */
...
/* The flat walk by identity, the last look `ea_scan_by_key()` takes. */
static hash_entry*
