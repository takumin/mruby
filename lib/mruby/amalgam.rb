...
module MRuby
  class Amalgam
    ...
    # The directories a gem's own headers are found under, in the order
    # they are written: the selected port's first, since the gem's HAL
    # header includes the port's feature header and has to come after it.
