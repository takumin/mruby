...
owes nothing. `mruby-io`, `mruby-dir` and `mruby-socket` each carry
such a header under `ports/posix/include/` and `ports/win/include/`,
and their READMEs list what each declares.
