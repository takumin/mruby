...
byte sequences by default. UTF-8 aware string operations come with
the `mruby-encoding` gem, which is also what makes case conversion
follow Unicode rather than ASCII; `MRB_USE_ASCII_CTYPE`
