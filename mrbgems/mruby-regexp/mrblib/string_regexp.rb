...
class String
  ...
  def gsub(*args, &block)
    ...
    # was written here for -- the block reading the globals of the match it
    # was handed -- a C loop publishes just as well, and it pays neither the
    # frame per search nor the array of pieces the mrblib one collected.
