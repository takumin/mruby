...
assert('Process::Status.new is undefined') do
  # As in CRuby, where the class has no allocator: a status reports what
  # happened to a process, so one written by hand reports nothing.  A
  # subclass inherits the absence rather than gaining a way round it.
