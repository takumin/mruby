...
** invariants of mruby/internal.h -- that only an env flagged as carrying
** the special-variable slot has one, and that a closed env sized without
** it grows into one on the first write that needs it -- are asked about
** from here.
*/
