 ...
 *
 * Where mrb_str_substr() counts characters with the mruby-encoding gem, this
 * counts bytes in every build, which is what a caller working from an offset
 * it found itself in the bytes wants.
 *
