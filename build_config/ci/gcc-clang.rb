...
MRuby::Build.new('ascii-ctype') do |conf|
  ...
  # 4096 -- 2.4 MiB is more than a Windows thread's whole stack, and the test
  # skips above 512 for that reason. This build sets a limit a test may reach
  # anywhere in the matrix, some 300 KiB, which is what gives
